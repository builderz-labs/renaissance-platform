...
function FormBanner() {
  ...
  return (
    <>
      {isVisible && (
        <div className="w-full flex flex-row justify-between items-center py-2 bg-renaissance-orange bg-opacity-40 rounded-md  px-2 sm:px-4  lg:px-8 mt-5">
          ...
          <div
            className={`flex items-center justify-center w-1/6 cursor-pointer transition-all duration-200 ${
              isVisible
