  ...
  return (
    <section className="my-10">
      <div className="w-full flex flex-row justify-between items-center py-4">
        ...
        <div className="max-w-xs flex items-center justify-center text-white">
          <FormControl
            ...
            size="small"
            className="select select-ghost relative z-0"
          >
      ...
      <div
        className={
          viewMode === "grid"
            ? "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 px-2 gap-4 mb-40"
            : "flex flex-col items-start justify-between w-full flex-wrap gap-2 px-2"
        }
      >
